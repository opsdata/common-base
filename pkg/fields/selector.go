...
import (
	...
	"github.com/opsdata/common-base/pkg/selection"
)
...
type Selector interface {
	...
	// Transform
	// - return a new copy of the selector after TransformFunc has been
	// applied to the entire selector
	// - or an error if fn returns an error
...
// SelectorFromSet
// - return a Selector which will match exactly the given Set
...
// UnescapeValue
// - unescape a fieldSelector value and return the original literal value
// - may return the original string if it contains no escaped or special characters
func UnescapeValue(s string) (string, error) {
	// If there is no escaping or special characters, just return to avoid allocation
...
// ParseSelectorOrDie
// - take a string representing a selector and return an object
// suitable for matching
// - or panic when an error occur
...
// ParseSelector
// - take a string representing a selector and returns an object
// suitable for matching
// - or an error
...
// - parse the selector and run them through the given TransformFunc.
...
// - return an object that match objects where one field/field equals one value
...
// - return an object that match objects where one field/field does not equal one value
// - can not return an error
...
// AndSelectors
// - create a selector that is the logical AND of all the given selectors
